// This page is for the sidebar, it recieves the name,path or whatever that is in the sidebar
//also there's on click , so if there is any sub parts , or a menu that has other components in it, like genre part
